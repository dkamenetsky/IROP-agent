  ...
  scenarios: [
    {
      ...
      message: 'PD218 is delayed 95 minutes. What should we do?',
    },
    {
      id: 'scenario-cancel',
      ...
      message: 'How should we handle the cancellation of PD412?',
    },
    {
      id: 'scenario-gate',
      title: 'Gate change',
      ...
      message: 'Gate changed for PD305 from A2 to A5. Give me a staffing plan.',
    },
    {
      id: 'scenario-inbound',
      ...
      message: 'A late inbound aircraft will push PD218 back by 70 minutes. Minimize overtime.',
    },
    {
      id: 'scenario-crew',
      ...
      message: 'PD412 has a crew timeout risk. Give me a contingency plan.',
    },
  ],
};
